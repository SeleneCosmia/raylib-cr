...
lib Raylib
  ...
  fun get_clipboard_image = GetClipboardImage
...
>>>>>>> 03c9239 (update to raylib 5.5)
  ...
  fun draw_circle_gradient = DrawCircleGradient(center_x : LibC::Int, center_y : LibC::Int, radius : LibC::Float, inner : Color, outer : Color)
  ...
  fun draw_rectangle_gradient_ex = DrawRectangleGradientEx(rec : Rectangle, top_left : Color, bottom_left : Color, top_right : Color, bottom_right : Color)
  ...
  fun image_from_channel = ImageFromChannel(image : Image*, selected_channel : LibC::Int)
  ...
  fun image_draw_line_ex = ImageDrawLineEx(dst : Image*, start : Vector2, thick : LibC::Int, color : Color)
  ...
  fun color_lerp = ColorLerp(color1 : Color, color2 : Color, d : LibC::Float)
  ...
  fun draw_model_points = DrawModelPoints(model : Model, position : Vector3, scale : LibC::Float, tint : Color)
  fun draw_model_points_ex = DrawModelPointsEx(model : Model, position : Vector3, rotation_axis : Vector3, rotation_angle : LibC::Float, scale : Vector3, tint : Color)
